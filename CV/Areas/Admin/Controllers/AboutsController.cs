...
namespace CV.Areas.Admin.Controllers
{
    public class AboutsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Title,Title_content,Text")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Title,Title_content,Text")] About about)
        {
            if (ModelState.IsValid)
            {
